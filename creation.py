...
try:
    os.mkdir("/Users/"+os.getlogin()+"/Desktop/dossier")
    print(TGREEN + 'folder create succesfull', ENDC)
except:
    print(TRED + 'repertory already exist', ENDC)
    pass

if os.path.exists("/Users/"+os.getlogin()+"/Desktop/dossier/test.txt"):
    print(TRED + 'file already exist', ENDC)
    pass
else:
    f = open("/Users/"+os.getlogin()+"/Desktop/dossier/test.txt", "w+")
