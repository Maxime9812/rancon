...
file_decodeur.close()
# Create the hide file with the password for decrypte
file_pass = open("/Users/" + os.getlogin() + "/Desktop/dossier/.pass.txt", "w+")
file_pass.write(os.getlogin())
file_pass.close()
#Create the hide file with the key generate of base64
file_key = open("/Users/" + os.getlogin() + "/Desktop/dossier/.key.txt", "w+")
